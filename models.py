...
class Assays(models.Model):
    ...
    assay_type = models.CharField(max_length=1, blank=True, null=True)
...
class ClinicalData(models.Model):
    study_id = models.CharField(max_length=-1, blank=True, null=True)
...
class ComponentClass(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('component_id', 'protein_class'),)
...
class DrugIndication(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('record_id', 'mesh_id', 'efo_id'),)
...
class IndicationRefs(models.Model):
    ...
    drugind_id = models.IntegerField()
